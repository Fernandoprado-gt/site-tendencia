...
const Navbar = () => {
  ...
  return <header className={cn("fixed top-0 left-0 right-0 z-50 transition-all duration-300", scrolled ? "bg-tendencia-darker/90 backdrop-blur-md py-2 shadow-lg" : "bg-transparent py-4")}>
      <div className="container mx-auto flex items-center justify-between">
        <a href="/" className="flex items-center">
          <img alt="Logo da Tendência | Estratégias Digitais" onError={e => {
          e.currentTarget.src = "https://placehold.co/200x50/1A1F2C/00F2FF?text=TENDÊNCIA";
        }} className="" src="/lovable-uploads/2d44a52f-ca96-4705-a9c3-92094ae60aa5.png" />
        </a>
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Button size="sm" className="bg-cyan-gradient hover:opacity-90 transition-opacity group" onClick={() => window.location.href = "https://wa.me/5521999999999"}>
        ...
        <Button size="sm" className="md:hidden bg-cyan-gradient hover:opacity-90 transition-opacity" onClick={() => window.location.href = "https://wa.me/5521999999999"}>
