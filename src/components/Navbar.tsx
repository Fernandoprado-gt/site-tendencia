  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? "bg-tendencia-darker/90 backdrop-blur-md py-2 shadow-lg"
          : "bg-transparent py-4"
      )}
    >
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <NavigationMenu>
            <NavigationMenuList className="gap-6">
              <NavigationMenuItem>
                <NavigationMenuLink
                  className="text-gray-300 hover:text-tendencia-cyan transition-colors"
                  href="#about"
                >
                  Sobre
                </NavigationMenuLink>
          ...
          <Button
            size="sm"
            className="bg-cyan-gradient hover:opacity-90 transition-opacity group"
        ...
        <Button
          size="sm"
          className="md:hidden bg-cyan-gradient hover:opacity-90 transition-opacity"
          onClick={() => window.location.href = "https://wa.me/5521999999999"}
        >
