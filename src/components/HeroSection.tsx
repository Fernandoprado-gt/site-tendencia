        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-gray-300">
              9 anos no digital. 5 anos dentro do mercado imobiliário. 
              Estratégias que geram resultado real.
            </p>
          ...
          <div className="bg-tendencia-dark/70 backdrop-blur-sm p-6 lg:p-8 rounded-2xl border border-tendencia-cyan/30 animate-fade-in" style={{ animationDelay: '0.3s' }}>
